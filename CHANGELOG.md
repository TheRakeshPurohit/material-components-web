...
# [14.1.0](https://github.com/TheRakeshPurohit/material-components-web/compare/v14.0.0...v14.1.0) (2025-02-06)


### Bug Fixes

* circular progress no longer cause dialogs to be scrollable ([9290bd3](https://github.com/TheRakeshPurohit/material-components-web/commit/9290bd3b0b919a022d6ff0cfd1c27bb66f7fd44b))
* **button:** fix theme elevation resolver ([2528c1c](https://github.com/TheRakeshPurohit/material-components-web/commit/2528c1c3b6b2a9870807df8c03c49ea45db811b7))
* **chip:** Propagate unhandled keyboard events ([6081d82](https://github.com/TheRakeshPurohit/material-components-web/commit/6081d829b081384ff8433a92bf91db364c588e16))
* **dialog:** Add tabindex=-1 to dialog surface and set its outline to 0 ([4e840d6](https://github.com/TheRakeshPurohit/material-components-web/commit/4e840d68533ef04e438c0b10f1047627a1d01e0c))
* **dialog:** fix dialog close button z-index in dark mode ([26bacc3](https://github.com/TheRakeshPurohit/material-components-web/commit/26bacc3feee6ea39c95b35b73c99040399b0f530))
* **floating-label:** Generate valid CSS calc ([304a94e](https://github.com/TheRakeshPurohit/material-components-web/commit/304a94e8bde786452d9d8c6b80e8e9e0d84bfcc2))
* **floating-label:** replaced incompatible value types in calc statement by compatible ones ([23073a3](https://github.com/TheRakeshPurohit/material-components-web/commit/23073a303310f5aad6a0fef0c2e96fd8dd7ab360))
* **focus:** Add z-index to focus ring. ([b0103d1](https://github.com/TheRakeshPurohit/material-components-web/commit/b0103d10aca7e6e8272cde283d9d36272702bf87))
* **focus ring:** Using box-shadow instead of border for focus ring as animating on box-shadow is more performant. ([3a705fa](https://github.com/TheRakeshPurohit/material-components-web/commit/3a705fa1d18089ae89c481b5bdfdfed2d378742e))
* **focusring:** add real color to focus ring ([15b2215](https://github.com/TheRakeshPurohit/material-components-web/commit/15b22154036ffb0fcadc7b404125a016e28e2b23))
* **formfield:** Change cursor style on label to `inherit` rather than `auto` to adopt customization. ([4b35cb7](https://github.com/TheRakeshPurohit/material-components-web/commit/4b35cb7d05ac0abf313963370ee2f4b20456df45))
* **formfield:** Fix for [#8187](https://github.com/TheRakeshPurohit/material-components-web/issues/8187) (rolling back the errant commit) ([2f5b899](https://github.com/TheRakeshPurohit/material-components-web/commit/2f5b899bc1a7e6dc4015186eed59d937aeb2d743))
* **linearprogress:** Fix `track-color` in Theming API ([79b1b61](https://github.com/TheRakeshPurohit/material-components-web/commit/79b1b612b9ec10a42caf5946efdead14e44e7f7a))
* **linearprogress:** Fix buffer dots animation when track height is increased ([0c53abc](https://github.com/TheRakeshPurohit/material-components-web/commit/0c53abc81c05b9afecc127380c700c99fac5d2f8))
* **linearprogress:** Fix missing buffering keyframes ([ea21914](https://github.com/TheRakeshPurohit/material-components-web/commit/ea219142617255a2b365823701b6ea43ff9a9611))
* **list:** Allow alt + enter to select index for lists. ([113b1a3](https://github.com/TheRakeshPurohit/material-components-web/commit/113b1a38e87337fdd00c7495fda3299df2dbc317))
* **list:** Fix list leading/trailing icon theming ([36a4cba](https://github.com/TheRakeshPurohit/material-components-web/commit/36a4cba9944392b391b86d41405ee21fb97f4c22))
* **list:** only set overflow hidden on mdc-list-item--with-leading-image ([033ae08](https://github.com/TheRakeshPurohit/material-components-web/commit/033ae083aad9ad4376e64aa328df936c7adb5a32))
* **list:** Remove ripple styles for disabled items in deprecated list. ([f52358d](https://github.com/TheRakeshPurohit/material-components-web/commit/f52358dd0796308919bb78deffc573d0d933c7de))
* **menu:** Account for empty map being passed to theme mixin ([0c52ade](https://github.com/TheRakeshPurohit/material-components-web/commit/0c52adeab4a46fb942e7ac64a950d094b54716f8))
* **menu:** do not require all for theme-styles ([1fb4b1a](https://github.com/TheRakeshPurohit/material-components-web/commit/1fb4b1a063ecaec1ad0d508b3f5ae5aca3e96652))
* **menu:** make require-all a theme-styles param. ([c64a277](https://github.com/TheRakeshPurohit/material-components-web/commit/c64a2776efe4f0aaaee5c32f5fb9ef3570483213))
* **select:** <fix inherited ellipsis color for list items in selects> ([c43b343](https://github.com/TheRakeshPurohit/material-components-web/commit/c43b3438b4b7eeb777072525f9ae07c97d27c0bb))
* **select:** add separate touch target element to Select to maintain size even when shrunk ([453a624](https://github.com/TheRakeshPurohit/material-components-web/commit/453a6248a0088c8243852fd20f83fa50c71f3a5f))
* `aria label` lint error in strings ([7f224dd](https://github.com/TheRakeshPurohit/material-components-web/commit/7f224ddd44f8ee0d2203103dd4ce6b2886dba72c))
* **textfield:** styles that override floating-label font-size take into account that clients can change this font-size. ([ebb636f](https://github.com/TheRakeshPurohit/material-components-web/commit/ebb636f3d44e1a194f822d7dfcb5d70feb817520))
* correct behavior of checkboxes/radios in a list. ([f771b09](https://github.com/TheRakeshPurohit/material-components-web/commit/f771b091ce1e5b1b97b3a508f1459e4665008a80))
* The focus ring shouldn't ignore the container-shape value ([7a3942e](https://github.com/TheRakeshPurohit/material-components-web/commit/7a3942e7ad206c3754dd34e2da62b88e4a9dc311))
* Use state-layer-size to correctly position the icon inside of an icon button ([0270229](https://github.com/TheRakeshPurohit/material-components-web/commit/02702296e31ef8f9e3068017c73b4740eb56b9cf))
* **menusurface:** Make "private" `base_` mixin truly private ([da22ca9](https://github.com/TheRakeshPurohit/material-components-web/commit/da22ca960bdac2e0a0fc9e67f6dc1e1164fbe73b))
* **menusurface:** reposition menu surface on window resize events ([6023b1c](https://github.com/TheRakeshPurohit/material-components-web/commit/6023b1cd3d2c1213d47ac68e053293270e3e371f))
* **select:** update text field in select to accept dynamic shape and height ([aa5ac7f](https://github.com/TheRakeshPurohit/material-components-web/commit/aa5ac7fe52b870752cd578715ad1760731c63aa5))
* **select:** use `text-field-disabled-trailing-icon-color` token ([adcdb7d](https://github.com/TheRakeshPurohit/material-components-web/commit/adcdb7db997f3d471346b05f7b8aefec522a96c2))
* **slider:** Move comment to correct location ([d7a2277](https://github.com/TheRakeshPurohit/material-components-web/commit/d7a2277dee780757318ff962277c109a7c615e12))
* **slider:** Remove support for deprecated `label-label-text-font-size` token ([8a74f7c](https://github.com/TheRakeshPurohit/material-components-web/commit/8a74f7c6d4dffc9e066d548e74ebd7ab1c58ac65))
* **slider:** Replace `label-label-text-font-size` token with `label-label-text-size` ([73537ab](https://github.com/TheRakeshPurohit/material-components-web/commit/73537ab0fe98dbf2dc4b824c128c4c05da6ff986))
* **slider:** Use CSS Variables instead of hardcoded values for track height ([067af7e](https://github.com/TheRakeshPurohit/material-components-web/commit/067af7eff1cc5f3de077068184dfbd31c76f5a41))
* **tabs:** Add validation to tab bar theme ([49041a6](https://github.com/TheRakeshPurohit/material-components-web/commit/49041a6c3c713973d289f7a7f3ffa4a991304620))
* **tabs:** adjust rippple area according to container shape ([8c0786d](https://github.com/TheRakeshPurohit/material-components-web/commit/8c0786d6f0dca33f9666912598386a04ca153d97))
* **textfield:** Add coverage for suffix and prefix text within the font size mixin. ([19bb36a](https://github.com/TheRakeshPurohit/material-components-web/commit/19bb36a46b51e79d8bf08948ab5b7d8e9358c2d8))
* **textfield:** add support for placeholder color in theme api ([b994146](https://github.com/TheRakeshPurohit/material-components-web/commit/b994146f6d849bd80f280c147d64adae5b930a3c))
* **textfield:** initializes 'valid' property from the DOM. ([b836b98](https://github.com/TheRakeshPurohit/material-components-web/commit/b836b989225a6259220a98dd23fd2a4b99014031))
* **theme:** account for null being passed into .theme-styles ([2a9697d](https://github.com/TheRakeshPurohit/material-components-web/commit/2a9697dc53e9c7b5b89cc479df9f97a46c095a43))
* **tooltip:** Stop keydown event propogation when ESC key is pressed. ([8d2d8d3](https://github.com/TheRakeshPurohit/material-components-web/commit/8d2d8d3c4dbe6c2a17a5de099d59f7503101999f))
* **tooltip:** Stop re-calculating the tooltip position if the anchor is scrolled out of view. ([684e33d](https://github.com/TheRakeshPurohit/material-components-web/commit/684e33d250337e53e46fec26c97b382ba85f60d0))
* **touch-target:** touch-target mixin now works as expected also when the arguments are custom property strings. ([0e89aab](https://github.com/TheRakeshPurohit/material-components-web/commit/0e89aab6b1651c9a22e6caa3c9a9f4b023ff61c3))
* use case-insensitive comparison for the tabindex attribute ([fd95ca7](https://github.com/TheRakeshPurohit/material-components-web/commit/fd95ca7ef8eb8479cf9eedceae6a80da4503595b))


### Features

* **banner:** Add Theming API support for graphic color and background color ([a0b8a90](https://github.com/TheRakeshPurohit/material-components-web/commit/a0b8a90c08a471b845dccc8a471bdd9650f61510))
* **banner:** Add Theming API support for max width and z-index ([e50b478](https://github.com/TheRakeshPurohit/material-components-web/commit/e50b478eb6ce6d54f0487a86572a20c645fac6c2))
* **button:** Introduced a new token: `"keep-touch-target"` to the `theme` mixin. ([21d1196](https://github.com/TheRakeshPurohit/material-components-web/commit/21d1196a7cae2760582c1cefb64e418e99f7d9b2))
* **button:** Ripple styles do not update on hover for disabled buttons. ([bf86521](https://github.com/TheRakeshPurohit/material-components-web/commit/bf86521f45b74c35f2f443dfb41a0c8361b5cf2c))
* **button:** Support state-layer-color theming for buttons and icon-buttons ([127a44b](https://github.com/TheRakeshPurohit/material-components-web/commit/127a44b284698c40533b2e52cd0311ec689aa026))
* **checkbox:** Support state-layer-color theming for GM2 checkboxes ([9cec940](https://github.com/TheRakeshPurohit/material-components-web/commit/9cec9409719681ad4e33b7369fb402f7e4b787b1))
* **chips:** Make light-theme tokens public ([51311e6](https://github.com/TheRakeshPurohit/material-components-web/commit/51311e69ec61d62c214e0020fb856c39919ee657))
* **datepicker, select, textfield:** Support customizing label size on these components. ([c0d21ec](https://github.com/TheRakeshPurohit/material-components-web/commit/c0d21ecc9704bea1cb7c8cd83c1c6e2971f1d01b))
* **dialog:** Add `z-indez` token to dialog theme styles mixin ([93fc524](https://github.com/TheRakeshPurohit/material-components-web/commit/93fc524b7889f5789096c9be8799ed5b619aed43))
* **dialog:** Add a chaining class that suppresses scrim animations. ([819498d](https://github.com/TheRakeshPurohit/material-components-web/commit/819498d8c9bd8c5c72d2f7b12ec082795b6628d1))
* **dialog:** Adding container-surface-tint as supported token for theme-API. ([446734f](https://github.com/TheRakeshPurohit/material-components-web/commit/446734f27bf1f7eadbf9d30c248649f46dd52cda))
* **fab:** Make extended-light-theme tokens public ([736b7fd](https://github.com/TheRakeshPurohit/material-components-web/commit/736b7fda40fce0e45eb95ca28df7ae9a7426b365))
* **fab:** Make light-theme tokens public ([b281a40](https://github.com/TheRakeshPurohit/material-components-web/commit/b281a409a8d63105dcd7b00dd8cd4a3e274e3495))
* **floatinglabel:** Extract `static-styles` mixin ([419b23c](https://github.com/TheRakeshPurohit/material-components-web/commit/419b23cc64946c0df1986986872e0faa58c3e817))
* **floatinglabel:** Extract `theme-styles` mixin ([87809c7](https://github.com/TheRakeshPurohit/material-components-web/commit/87809c7103e24f1988763c1103fde000f413c4df))
* **focus ring:** BREAKING_CHANGE Renaming focus-ring files in preparation for splitting focus-ring into two variants. One with an outward entrance animation, and one with an inward animation. ([e8912fd](https://github.com/TheRakeshPurohit/material-components-web/commit/e8912fd3741e891a71a19b7370fa922358bdd278))
* **focus ring:** Defining styles for focus ring variant that animates inwards. ([16fbd30](https://github.com/TheRakeshPurohit/material-components-web/commit/16fbd30ffe8176e7a049663782c95456eaa95825))
* **focus-ring:** Add RTL support to focus ring mixin. ([65c10a6](https://github.com/TheRakeshPurohit/material-components-web/commit/65c10a622f0c2aee07daeccb7fa66109ba43db98))
* **focus-ring:** add Sass mixin for testing ([6a4b3f8](https://github.com/TheRakeshPurohit/material-components-web/commit/6a4b3f834d4f512a68e46f6fe56c4e52bc737004))
* **focus-ring:** Adds animation for focus-ring. ([c492898](https://github.com/TheRakeshPurohit/material-components-web/commit/c492898c238efd7a46476f4c0181e65bbbe04778))
* **focus-ring:** support variable shapes in outward variant ([311ab4d](https://github.com/TheRakeshPurohit/material-components-web/commit/311ab4d4aa4367ee99d505b89c1550cce81345e4))
* **focus-ring:** Update $ring-radius to support list type values  so a focus ring can follow custom shapes ([311f29a](https://github.com/TheRakeshPurohit/material-components-web/commit/311f29a60e0008ea8480d5fa418e570a96b6e694))
* **focusring:** Extra bottom offset for inward focus ring ([6fcd8d4](https://github.com/TheRakeshPurohit/material-components-web/commit/6fcd8d41839a069202e48f7dace96739ad21d078))
* **formfield:** Add `mdc-label` class to `<label>` ([55093ee](https://github.com/TheRakeshPurohit/material-components-web/commit/55093ee1e347fc68360a7fa1b45e1cc7f80cc683))
* **formfield:** Add `theme` mixin ([ed7e82d](https://github.com/TheRakeshPurohit/material-components-web/commit/ed7e82dedcea18db05621abd0a44a3c002cb65e8))
* **formfield:** Extract `static-styles` mixin ([d441d2a](https://github.com/TheRakeshPurohit/material-components-web/commit/d441d2a2ac5a4a69db1fd867a6bf959b1f7492cd))
* **formfield:** Extract `theme-styles` mixin ([48d3001](https://github.com/TheRakeshPurohit/material-components-web/commit/48d30012d6605a3038d912d455b98a5f528c2760))
* **linearprogress:** Add `bar-and-track-height` token ([51f9c0c](https://github.com/TheRakeshPurohit/material-components-web/commit/51f9c0c28888cc20bcfd982e3c3ee6d8701b276c))
* **linearprogress:** Implement `track-shape` token ([90291f2](https://github.com/TheRakeshPurohit/material-components-web/commit/90291f2e27c48df2958bdf5fd1854b79f032cf96))
* **linearprogress:** Implement separate `track-height` and `active-indicator-height` tokens ([3b5b55e](https://github.com/TheRakeshPurohit/material-components-web/commit/3b5b55e31a3f69bc1b4f380f57b9276bfb2ad4a8))
* **lineripple:** Extract `static-styles` mixin ([112715d](https://github.com/TheRakeshPurohit/material-components-web/commit/112715df5ae369f78b6ef12fe4aa88debb451ef2))
* **lineripple:** Extract `theme-styles` mixin ([1c8013f](https://github.com/TheRakeshPurohit/material-components-web/commit/1c8013f4e7f2b10ce1473177ec0f377da4592295))
* **list:** Add support for list-item-selected-container-color and list-item-selected-trailing-icon-color tokens. ([ece3e8d](https://github.com/TheRakeshPurohit/material-components-web/commit/ece3e8d2155abd93bc1f9bdcf2dddea9e6eaab56))
* **map-ext:** add a `map-get-or-err` helper function. ([d9f8210](https://github.com/TheRakeshPurohit/material-components-web/commit/d9f821042d192caddabfa88d0d95c54454cd9a58))
* **map-ext:** Rename `map-ext.map-get-or-err()` to `map-ext.get()` ([68edc03](https://github.com/TheRakeshPurohit/material-components-web/commit/68edc03c6b3b66bb2b92ea69ed28bf12f8b9b66d))
* **menu:** Add `static-styles` mixin ([a274583](https://github.com/TheRakeshPurohit/material-components-web/commit/a274583b97fd1fe27eaaca9cba5f890173bebb2e))
* **menu:** HCM border-radius is no longer clipped ([6160219](https://github.com/TheRakeshPurohit/material-components-web/commit/6160219ff039dac7666f8cb04c53f7eb89e2062b))
* **menusurface:** Extract `static-styles` mixin ([de52246](https://github.com/TheRakeshPurohit/material-components-web/commit/de52246336da4a3629d8e85c18e482e8d8cdf1fe))
* **menusurface:** Extract `theme-styles` mixin ([a71501b](https://github.com/TheRakeshPurohit/material-components-web/commit/a71501b1332ccb95f49e48ee7c1463ce98a43130))
* **notchedoutline:** Extract `static-styles` mixin ([1bd3172](https://github.com/TheRakeshPurohit/material-components-web/commit/1bd317240624d58bf9025046386fd1b25d22227b))
* **notchedoutline:** Extract `theme-styles` mixin ([989ae2e](https://github.com/TheRakeshPurohit/material-components-web/commit/989ae2ecc5d9d9636628806a4984e182e44931ba))
* **select:** Add support for `text-field-focus-active-indicator-height` theme key. ([de38de7](https://github.com/TheRakeshPurohit/material-components-web/commit/de38de7584a5552e93a3f92db5fb9d397fa2e986))
* **select:** Allow styling bottom border radii in Material Selects. By default, to preserve compatibility with existing styling, border-radius still only styles top radii unless all four values are specified. ([83355c3](https://github.com/TheRakeshPurohit/material-components-web/commit/83355c32274a6b461016e449f663a389427364ba))
* **select:** Select foundation preserves describedby elements on validate ([7644d63](https://github.com/TheRakeshPurohit/material-components-web/commit/7644d63d5a4eed96766ec063ce76b8e22e362b46))
* **select:** Select foundation preserves describedby elements on validate ([901c83e](https://github.com/TheRakeshPurohit/material-components-web/commit/901c83e770dd7c0326c2013eaa5d7bf9dca30a6d))
* **select:** Select foundation preserves describedby elements on validate ([fa27ba6](https://github.com/TheRakeshPurohit/material-components-web/commit/fa27ba61d48c66d0d56b93039738380285d9ad4a))
* **slider:** Moves native inputs into thumbs to improve a11y. ([47c7deb](https://github.com/TheRakeshPurohit/material-components-web/commit/47c7deb19df667d31f65d7742509fb883e4501f5))
* **snackbar:** Add support for secondary action button ([a9ff986](https://github.com/TheRakeshPurohit/material-components-web/commit/a9ff9866f237fbeebe94e655ae578b68ce675a04))
* **text-field:** add the ability to hide the asterisk required marker in floating labels ([f476fde](https://github.com/TheRakeshPurohit/material-components-web/commit/f476fdece526e3aa45441b2d11f7ac17f63e856f))
* **textfield:** $custom-property-prefix is no longer private variable (same as outlined textfield). ([d76666a](https://github.com/TheRakeshPurohit/material-components-web/commit/d76666ad4c53a619946d70b3991ca35ae5d87d04))
* **textfield:** Add `static-styles` mixin ([82554d7](https://github.com/TheRakeshPurohit/material-components-web/commit/82554d7709f8945af78415597d9b121afaddd1c0))
* **textfield:** changed the visibility of the mixin `filled-no-label` to public ([8879557](https://github.com/TheRakeshPurohit/material-components-web/commit/8879557e677d9b160a106e46279b1b6855926fb5))
* **textfield:** Changed visibility of $custom-property-prefix to public ([d96330c](https://github.com/TheRakeshPurohit/material-components-web/commit/d96330c085b4fe8fc59c7eb835d41ebca3a08422))
* **textfield:** Changed visibility of $custom-property-prefix to public ([f323399](https://github.com/TheRakeshPurohit/material-components-web/commit/f323399371aec4378186a05b5a839e53d9e464c0))
* **textfield:** Changed visibility of $custom-property-prefix to public. ([274610c](https://github.com/TheRakeshPurohit/material-components-web/commit/274610c77e6a9c9f19780b688cc6686a97e453a1))
* **tooltip:** Add mixin to set max-width of rich tooltip. ([cfec83c](https://github.com/TheRakeshPurohit/material-components-web/commit/cfec83c749a1b6b6602c4d2fa474d3e776e7c97b))
* **tooltip:** Fix rich tooltip title alignment (multiline titles should be start aligned). ([099ea3a](https://github.com/TheRakeshPurohit/material-components-web/commit/099ea3aa775d595a48f68e4e53ef7c69a12ef0a5))
* **tooltip:** Interactive rich tooltip content becomes scrollable if it extends beyond the max-height limit. ([0ad1283](https://github.com/TheRakeshPurohit/material-components-web/commit/0ad128337d689ca084fbda457a7204daa750b792))
* Modify NotifyOpening event to emit after adding the "--opening" class so that the banner's contentHeight is visible to listeners handling the `opening` event ([b2ddacf](https://github.com/TheRakeshPurohit/material-components-web/commit/b2ddacf738a9fc404225ff2c23169000dd69ddd1))
* **tooltip:** No longer re-calculate persistent rich tooltip's position on scroll. ([5cb8e21](https://github.com/TheRakeshPurohit/material-components-web/commit/5cb8e2174bb381556fc684283748659b322dc158))
